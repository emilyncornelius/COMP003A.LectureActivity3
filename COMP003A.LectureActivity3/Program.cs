...
namespace COMP003A.LectureActivity3
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                // this code block executes if inputNumver is NOT divisible by 2
                Console.WriteLine("\tinputNumber is odd.");
            }
            ...
            if (inputNumber % 2 == 0)
            {
                ...
                // the rest of the condtions will no longer execute
            ...
            else
            {
                ...
                Console.WriteLine("tinputNumber is NOT divisible by 2/3/5/7.");
            }
